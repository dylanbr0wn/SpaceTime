    ...
    return (
        <>
            <div className="group flex my-2  ">
                ...
                <div className="flex-grow bg-slate-700 transition-colors duration-300 group-hover:bg-slate-500 my-auto mx-1 h-[3px] rounded-md " />
            </div>
        </>
    );
};
