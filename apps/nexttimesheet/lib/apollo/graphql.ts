...
export type FieldsQuery = { __typename?: 'Query', fields: Array<{ __typename?: 'Field', createdAt: Date | string, id: string, isActive: boolean, name: string, updatedAt: Date | string }> };
