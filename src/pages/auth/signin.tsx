				...
				<div className="flex flex-col card-body ">
					...
					<div className="flex flex-col space-y-2 mt-3">
						...
						>
							...
							<div className="w-full px-2 my-auto">Sign in with GitHub</div>
						</button>
						<button
						...
						>
							...
							<div className="w-full px-2 my-auto">Sign in with Discord</div>
						</button>
						<button
						...
						>
							...
							<div className="w-full px-2 my-auto">Sign in with Twitter</div>
						</button>
