...
const ProjectForm = ({
	...
	const formIsValid = () => {
		...
		if (projectChanges.GLCode ? projectChanges.GLCode.length > 50 : false)
			errors.GLCode = "Project GLCode must be less than 20 characters long.";
			...
			<Form>
				...
				<Row>
					<Col>
						<Form.Group controlId="ProjectID">
							<Form.Label className="font-weight-bold">Project ID</Form.Label>
							<Form.Control
								type="number"
								placeholder="Project ID"
								name="ProjectID"
								value={projectChanges.ProjectID ? projectChanges.ProjectID : ""}
								onChange={handleChange}
								disabled
							/>
						</Form.Group>
					...
					<Col>
						<Form.Group controlId="DepartmentID">
							...
							<Form.Control
								...
								custom
								value={
									projectChanges.DepartmentID ? projectChanges.DepartmentID : -1
								}
								onChange={handleChange}
								name="DepartmentID"
				...
				<Form.Group controlId="Description">
					...
					<Form.Control
						...
						name="Description"
						value={projectChanges.Description ? projectChanges.Description : ""}
						onChange={handleChange}
				...
				<Row>
					<Col>
						<Form.Group controlId="GLCode">
							<Form.Label className="font-weight-bold">GLCode</Form.Label>
							<Form.Control
								type="text"
								placeholder="GLCode"
								name="GLCode"
								value={projectChanges.GLCode ? projectChanges.GLCode : ""}
								onChange={handleChange}
					...
					<Col>
						<Form.Group controlId="Department Code">
							...
							<Form.Control
								...
								name="DeptCode"
								value={projectChanges.DeptCode ? projectChanges.DeptCode : ""}
								onChange={handleChange}
				...
				<Form.Group controlId="IsActive">
					...
					<Form.Check
						...
						name="IsActive"
						checked={projectChanges.IsActive ? projectChanges.IsActive : false}
						onChange={handleChange}
					/>
				</Form.Group>
			</Form>
