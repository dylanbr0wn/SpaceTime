...
const DepartmentForm = ({
	...
	const formIsValid = () => {
		...
		if (departmentChanges.DeptName.length > 50)
			errors.DeptName = "Department name must be less than 50 characters long.";
	...
	return (
		<Modal
			...
			title={department.DepartmentID ? "Edit Department" : "Create Department"}
		>
			<Form>
				<Form.Group controlId="DeptName">
					<Form.Label className="font-weight-bold">Department Name</Form.Label>
					<Form.Control
						type="text"
						placeholder="Department Name"
						name="DeptName"
						value={departmentChanges.DeptName ? departmentChanges.DeptName : ""}
				...
				<Form.Group controlId="DepartmentID">
					<Form.Label className="font-weight-bold">Department ID</Form.Label>
					<Form.Control
						type="text"
				...
				<Form.Group controlId="IsActive">
					...
					<Form.Check
						...
						name="IsActive"
						checked={
							departmentChanges.IsActive ? departmentChanges.IsActive : false
						}
						onChange={handleChange}
					/>
				</Form.Group>
