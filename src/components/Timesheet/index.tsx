...
import { Status as TimesheetStatus } from "../../utils/types/zod";
...
const Timesheet = () => {
	...
	const [timesheetQueryDate, setTimesheetQueryDate] = React.useState<Date>(
		DateTime.now().startOf("day").toUTC().startOf("day").toJSDate()
	);
				...
				<div className="w-full flex max-w-screen-xl mx-auto">
					...
					<div className="w-full flex justify-end">
						...
						<Status
							...
							status={timesheetFromDate?.status ?? TimesheetStatus.Unsubmitted}
